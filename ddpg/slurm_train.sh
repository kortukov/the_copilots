...
# python  train.py -e SelfPlayVar -m 10000 --agent TD3 --model resulting_models/strongest_td3.pth --results-dir results/$SLURM_JOB_NAME 
# python  train.py -e SelfPlay -m 100000 --agent TD3 --model resulting_models/self_td3.pth --results-dir results/$SLURM_JOB_NAME 
python  train.py -e HockeyTrainDefense --big-model -m 15000 --lr 0.001 --agent TD3 --model results/big_sho/TD3_HockeyTrainDefense_5000-eps0.1-t32-l0.0001-s42.pth --results-dir results/$SLURM_JOB_NAME 
